package MediaWiki::Parser::Token::Text;
...
MediaWiki::Parser::Token::Text - a text token.

=head1 SYNPOSIS

    my $token = MediaWiki::Parser::Token::Text->new(
        text => "Hello World!",
    );

=head1 DESCRIPTION

This is a token sub-class that represents a regular text token.
